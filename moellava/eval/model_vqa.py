...
def eval_model(args):
    ...
    # tokenizer, model, processor, context_len = load_pretrained_model(model_path, args.model_base, model_name, image_tower_cache_dir=args.image_tower_cache_dir)
    ...
    for line in tqdm(questions):
        ...
        #     print(f"Converting grayscale image to RGB: {image_file}")
        ...
        with torch.inference_mode():
            output_ids = model.generate(
                input_ids,
                images=image_tensor.unsqueeze(0).half().npu(),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_tower_cache_dir", type=str, default=None)
