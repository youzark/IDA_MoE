...
cd ${MOE_HOME}
run_inference "/apdcephfs_nj7/share_1273717/yannhua/Home/moe/checkpoints" "llavaqwen-1.8b-finetune-moe-math-normal" &
run_inference "/apdcephfs_nj7/share_1273717/yannhua/Home/moe/checkpoints" "llavaqwen-1.8b-finetune-moe-math-sharpenv1" &
wait

# Then calculate scores sequentially
calculate_scores "llavaqwen-1.8b-finetune-moe-math-normal"
calculate_scores "llavaqwen-1.8b-finetune-moe-math-sharpenv1"
