...
function calculate_mmvet_scores() {
    local CKPT_NAME=$1
    MOE_HOME="/apdcephfs_nj7/share_1273717/yannhua/Home/moe"
    EVAL="/root/eval"
...
run_mmvet_inference "llavaqwen-1.8b-finetune-moe_v2" &
run_mmvet_inference "llavaqwen-1.8b-finetune-moe-sharpen_v2" &
# wait

# Then calculate scores sequentially
calculate_mmvet_scores "llavaqwen-1.8b-finetune-moe_v2"
calculate_mmvet_scores "llavaqwen-1.8b-finetune-moe-sharpen_v2"
